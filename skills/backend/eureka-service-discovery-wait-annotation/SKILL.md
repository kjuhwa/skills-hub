...
trigger: Service startup must wait for other microservices (metadata, auth, config) to be registered AND healthy in Eureka before running initialization logic
---
