...
summary: Overview of CCGS workflow examples and how to use them as references
category: reference
confidence: medium
tags: [game-studios, ccgs, examples, reference, workflow]
...
source_path: docs/examples/README.md
