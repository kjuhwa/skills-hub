...
version: 0.1.0-draft
name: unity-plugins
summary: Recommended Unity plugins and their integration guidance for CCGS projects
category: engine
confidence: medium
tags: [game-studios, ccgs, unity, plugins, engine-reference]
...
source_path: docs/engine-reference/unity/PLUGINS.md
