...
version: 0.1.0-draft
name: unreal-plugins
summary: Recommended Unreal Engine plugins and integration guidance for CCGS projects
category: engine
confidence: medium
tags: [game-studios, ccgs, unreal, plugins, engine-reference]
...
source_path: docs/engine-reference/unreal/PLUGINS.md
