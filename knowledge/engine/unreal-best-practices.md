...
summary: Current Unreal Engine best practices for CCGS projects
category: engine
confidence: medium
tags: [game-studios, ccgs, unreal, best-practices, engine-reference]
...
source_path: docs/engine-reference/unreal/current-best-practices.md
