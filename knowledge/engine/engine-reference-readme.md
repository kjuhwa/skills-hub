---
name: engine-reference-readme
summary: Overview of the CCGS engine reference library covering Godot, Unity, and Unreal
category: engine
confidence: medium
tags: [game-studios, ccgs, engine-reference, godot, unity, unreal]
...
source_path: docs/engine-reference/README.md
