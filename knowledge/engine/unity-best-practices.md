...
summary: Current Unity best practices for CCGS projects
category: engine
confidence: medium
tags: [game-studios, ccgs, unity, best-practices, engine-reference]
...
source_path: docs/engine-reference/unity/current-best-practices.md
