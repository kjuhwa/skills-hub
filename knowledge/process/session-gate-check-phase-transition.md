---
version: 0.1.0-draft
name: session-gate-check-phase-transition
summary: Example gate-check session showing phase transition validation from design to production
category: process
confidence: medium
tags: [game-studios, ccgs, gate-check, phase-transition, session-example]
...
source_path: docs/examples/session-gate-check-phase-transition.md
