---
version: 0.1.0-draft
name: session-scope-crisis-decision
summary: Example session handling a scope crisis decision with scope-check and stakeholder alignment
category: process
confidence: medium
tags: [game-studios, ccgs, scope-check, crisis-management, session-example]
...
source_path: docs/examples/session-scope-crisis-decision.md
