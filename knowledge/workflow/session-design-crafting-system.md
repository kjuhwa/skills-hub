---
version: 0.1.0-draft
name: session-design-crafting-system
summary: Example session for designing a crafting system GDD using the design-system skill
category: workflow
confidence: medium
tags: [game-studios, ccgs, design-system, crafting, session-example]
...
source_path: docs/examples/session-design-crafting-system.md
