---
version: 0.1.0-draft
name: session-ux-pipeline
summary: Example UX pipeline session covering ux-design, ux-review, and implementation handoff
category: workflow
confidence: medium
tags: [game-studios, ccgs, ux-design, ux-review, pipeline, session-example]
...
source_path: docs/examples/session-ux-pipeline.md
