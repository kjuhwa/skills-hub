---
version: 0.1.0-draft
name: session-design-system-skill
summary: Example session demonstrating end-to-end usage of the design-system skill workflow
category: workflow
confidence: medium
tags: [game-studios, ccgs, design-system, session-example, workflow]
...
source_path: docs/examples/session-design-system-skill.md
