---
version: 0.1.0-draft
name: session-adopt-brownfield
summary: Example session transcript for adopting and onboarding a brownfield (existing) project
category: workflow
confidence: medium
tags: [game-studios, ccgs, adopt, brownfield, session-example, onboarding]
...
source_path: docs/examples/session-adopt-brownfield.md
