---
name: session-implement-combat-damage
summary: Example session implementing combat damage mechanics using dev-story and code-review skills
category: workflow
confidence: medium
tags: [game-studios, ccgs, dev-story, combat, session-example, implementation]
...
source_path: docs/examples/session-implement-combat-damage.md
