---
name: windows-polyglot-claude-code-hooks
summary: Cross-platform polyglot wrapper technique for Claude Code plugin hooks that must run on Windows, macOS, and Linux without shebangs
category: pitfall
confidence: medium
tags: [superpowers, pitfall]
