---
version: 0.1.0-draft
name: skill-test-spec-template
summary: Template for writing CCGS skill test specifications (behavioral test format)
category: testing
confidence: medium
tags: [game-studios, ccgs, testing, template, skill-spec]
...
source_path: CCGS Skill Testing Framework/templates/skill-test-spec.md
